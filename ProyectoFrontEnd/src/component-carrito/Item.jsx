    ...
    <>
            ...
            mx-8 text-center gap-2 place-items-center'>
                ...
                <div className='flex items-center col-span-full md:col-span-1 lg:col-span-2 xl:col-span-1'>
                    <button className="bg-gray-700 text-white font-bold py-1 px-2 my-1 rounded-full w-[2rem] h-[2rem] cursor-pointer mx-auto" 
                ...
                <button className="bg-gray-700 text-white hover:bg-first_color hover:text-red-500 font-bold hover:font-bold
