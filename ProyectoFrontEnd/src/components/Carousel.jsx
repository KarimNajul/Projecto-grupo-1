...
import SwiperCore, { Pagination, Navigation, EffectCoverflow } from 'swiper/core';
      ...
      >
        ...
        <div className="flex items-center justify-center h-96">
          <img
            ...
            alt="Slide 1"
            className="w-96 h-full max-w-full shadow-xl object-cover"
          />
        </div>
        </SwiperSlide>
        <SwiperSlide>
        ...
        <div className="flex items-center justify-center h-96">
          <img
            ...
            alt="Slide 1"
            className="w-auto h-full shadow-xl object-cover"
          />
        </div>
        </SwiperSlide>
        {/* <SwiperSlide>
